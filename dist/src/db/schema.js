...
import { mysqlEnum, mysqlTable, int, uniqueIndex, varchar, timestamp, text, } from 'drizzle-orm/mysql-core';
...
export const course_learningMaterialRelationsOne = relations(course_learningMaterial, ({ one }) => ({
    course: one(courses, {
...
export const course_FeatureRelationsOne = relations(course_Feature, ({ one }) => ({
    course: one(courses, {
...
export const course_TestimonialRelationsOne = relations(course_Testimonial, ({ one }) => ({
    course: one(courses, {
...
export const course_BenefitRelationsOne = relations(course_Benefit, ({ one }) => ({
    course: one(courses, {
