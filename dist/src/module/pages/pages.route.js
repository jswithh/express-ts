...
router
    ...
    .post('/create', [checkAuth, checkRole(['admin', 'user'])], pageController.create)
    .patch('/update/:id', [checkAuth, checkRole(['admin', 'user'])], pageController.update)
    .delete('/delete/:id', [checkAuth, checkRole(['admin', 'user'])], pageController.delete);
