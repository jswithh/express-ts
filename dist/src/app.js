...
app.use('/api/categories', require('./module/categories/categories.route').default);
app.use('/api/course', require('./module/courses/course/course.route').default);
app.use('/api/course/learning-material', require('./module/courses/learning-material/learning-material.route').default);
app.use('/api/course/faq', require('./module/courses/faq/faq.route').default);
app.use('/api/course/feature', require('./module/courses/feature/feature.route').default);
app.use('/api/course/benefit', require('./module/courses/benefit/benefit.route').default);
app.use('/api/course/seo', require('./module/courses/seo/seo.route').default);
app.use('/api/course/testimonial', require('./module/courses/testimonial/testimonial.route').default);
